...
export const RegisterForm = (props) => {
    ...
    return (props.trigger) ? (
        <div className="custom-layout">
            <section className="vh-100 popup">
                                            ...
                                            <form className="mx-1 mx-md-4" onSubmit={handleSubmit}>
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-4">
                                                    ...
                                                    <div data-mdb-input-init className="form-outline flex-fill mb-0">
                                                        <input type="text" id="form3Example1c" className="form-control" name='firstName' value={form.firstName} onChange={handleChange} />
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-4">
                                                    ...
                                                    <div data-mdb-input-init className="form-outline flex-fill mb-0">
                                                        <input type="text" id="form3Example4cd" className="form-control" name='lastName' value={form.lastName} onChange={handleChange} />
